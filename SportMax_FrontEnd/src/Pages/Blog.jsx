...
export const Blog = () => {
  ...
  return (
    <div className="grid wide blog-wrap-all">
      <div className="row">
        <div className="blog-info__header col l-12 m-12 c-12">
          <h2>TIN TỨC</h2>
          <hr />
        </div>
        ...
        <div className="row blog-wrap">
          <div className={`blog-img col c-12 ${isExpanded ? 'l-12 m-12' : 'l-6 m-6'}`}>
            <img className='col l-12 m-12 c-12' src={blog_01} alt="" />
          </div>
          <div className={`blog-content col l-6 c-12 ${isExpanded ? 'l-12 m-12 blog-content-tablet' : 'l-6 m-6'}`}>
            <h2 className="blog-header">BLACK FRIDAY - TẬN HƯỞNG MUA SẮM CỰC ĐÃ DÀNH RIÊNG CHO DÂN THỂ HÌNH</h2>
            <div className="blog-time">
              <p className="blog__time-post">Th 7 21/11/2020</p>
              <p className="blog__time-read">1 phút đọc</p>
            </div>
            <div className={`blog-desc col l-12 m-12 c-12 ${isExpanded ? '' : 'blog__limit-row'}`}>
            ...
            <button className='blog-view-more' onClick={handleToggleContent}>
        ...
        {/* Blog-02 */}
        <div className="row blog-wrap">
          <div className={`blog-img col c-12 ${isExpanded_2 ? 'l-12 m-12' : 'l-6 m-6'}`}>
            <img className='col l-12 m-12 c-12' src={blog_02} alt="" />
          </div>
          <div className={`blog-content col l-6 c-12 ${isExpanded_2 ? 'l-12 m-12 blog-content-tablet' : 'l-6 m-6'}`}>
            <h2 className="blog-header">BLACK FRIDAY - TẬN HƯỞNG MUA SẮM CỰC ĐÃ DÀNH RIÊNG CHO DÂN THỂ HÌNH</h2>
            <div className="blog-time">
              <p className="blog__time-post">Th 7 21/11/2020</p>
              <p className="blog__time-read">1 phút đọc</p>
            </div>
            <div className={`blog-desc col l-12 m-12 c-12 ${isExpanded_2 ? '' : 'blog__limit-row'}`}>
    ...
    <p>Ung thư trải qua bao nhiêu năm vẫn là căn bệnh nan y và không có một phương pháp đặc trị hữu hiệu. Sở hữu một lối sống lành mạnh, tiêu thụ những thực phẩm lành tính là một trong những việc làm giảm nguy cơ phát triển của một số loại ung thư. Quả óc chó là một nguồn thực phẩm chứa các hợp chất thực vật có lợi, chúng có thể là một phần hiệu quả của chế độ ăn phòng ngừa ung thư. Hơn thế nữa, trong quả óc chó có chứa một số thành phần hoạt tính sinh học có thể có đặc tính chống ung thư, như là Phytosterol, gamma-tocopherol, axit béo omega-3, axit ellagic và các</p>
            ...
            <button className='blog-view-more' onClick={handleToggleContent_2}>
        ...
        {/* Blog-03 */}
        <div className="row blog-wrap">
          <div className={`blog-img col c-12 ${isExpanded_3 ? 'l-12 m-12' : 'l-6 m-6'}`}>
            <img className='col l-12 m-12 c-12' src={blog_03} alt="" />
          </div>
          <div className={`blog-content col l-6 c-12 ${isExpanded_3 ? 'l-12 m-12 blog-content-tablet' : 'l-6 m-6'}`}>
            <h2 className="blog-header">HƯỚNG DẪN SĂN SALE CHƯƠNG TRÌNH ƯU ĐÃI ĐẶC QUYỀN CHO MEMBER VÀ FAN CỨNG</h2>
            <div className="blog-time">
              <p className="blog__time-post">Th 7 21/03/2020
              </p>
              <p className="blog__time-read">1 phút đọc</p>
            </div>
            <div className={`blog-desc col l-12 m-12 c-12 ${isExpanded_3 ? '' : 'blog__limit-row'}`}>
            ...
            <button className='blog-view-more' onClick={handleToggleContent_3}>
       ...
       {/* Blog-04 */}
       <div className="row blog-wrap">
          <div className={`blog-img col c-12 ${isExpanded_4 ? 'l-12 m-12' : 'l-6 m-6'}`}>
            <img className='col l-12 m-12 c-12' src={blog_04} alt="" />
          </div>
          <div className={`blog-content col l-6 c-12 ${isExpanded_4 ? 'l-12 m-12 blog-content-tablet' : 'l-6 m-6'}`}>
            <h2 className="blog-header">CẢNH BÁO LỪA ĐẢO: GỬI TỚI TOÀN BỘ KHÁCH HÀNG GYMMAX</h2>
            <div className="blog-time">
              <p className="blog__time-post">Th 7 21/03/2020
              </p>
              <p className="blog__time-read">1 phút đọc</p>
            </div>
            <div className={`blog-desc col l-12 m-12 c-12 ${isExpanded_4 ? '' : 'blog__limit-row'}`}>
              <p className='blog-desc-bold'>Thời gian vừa qua, đã có một số đối tượng xấu lợi dụng thương hiệu GYMMAX để trục lợi, với thủ đoạn tinh vi mà quý khách hàng cần biết.</p>
              ...
              <p className='blog-desc-italic'>"GYMMAX không và sẽ không bao giờ có chương trình yêu cầu khách hàng chuyển tiền trước. Vậy nên quý khách hàng hãy trở nên thông thái, nói KHÔNG với các động thái có hành vi lừa đảo, và hãy báo ngay cho GYMMAX để chúng tôi có phương án xử lý thích hợp."</p>
              <img className='col l-12 m-12 c-12' src={blog_04_1} alt="" />
              <p className='blog-center blog-desc-italic'>***Cảnh giác trước các số điện thoại lạ và hành vi lừa đảo yêu cầu chuyển tiền.***</p>
            ...
            <button className='blog-view-more' onClick={handleToggleContent_4}>
